/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf8ba64f391de8a68f4f75c43e3da1ae)
// Runtime types generated with workerd@1.20260521.1 2026-05-25 nodejs_compat
interface __BaseEnv_Env {
	RATE_LIMIT_KV: KVNamespace;
	RATE_LIMITER_MINUTE: RateLimit;
	ALLOWED_ORIGINS: "http://localhost:3000,http://localhost:5173,http://localhost:8788,http://localhost:9001,http://127.0.0.1:8788,http://127.0.0.1:9001,https://skillpassport.rareminds.in,https://www.skillpassport.rareminds.in,https://*.rareminds.in,https://*.pages.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "EMAIL_API_KEY" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_REGION" | "DEFAULT_FROM_EMAIL" | "DEFAULT_FROM_NAME" | "ENVIRONMENT" | "MESSAGECENTRAL_CUSTOMER_ID" | "MESSAGECENTRAL_KEY">> {}
}
